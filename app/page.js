...
export default function Storefront() {
  ...
  useEffect(() => {
    fetch("/api/catalog/products")
      .then(async (response) => { const data = await response.json(); if (!response.ok) throw new Error(data.error); setProducts(data.products || []); setDiscountRules(data.discountRules || []); })
